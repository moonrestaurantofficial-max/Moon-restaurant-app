...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`mx-auto max-w-7xl rounded-[24px] border px-3 shadow-sm transition-all duration-500 sm:px-5 ${
            isScrolled
              ? 'border-[rgb(var(--border))] bg-white'
              : 'border-white/10 bg-[rgb(var(--primary))]'
          }`}
        >
        ...
        <AnimatePresence>
          ...
          className="mx-auto mt-2 max-w-7xl overflow-hidden rounded-3xl border border-[rgb(var(--border))] bg-white shadow-sm md:hidden"
        >
